...
$define = [
    ...
    'HEADING_ADD_TITLE' => '<h1>Add My Testimonial</h1>',
    ...
    'TEXT_TESTIMONIALS_DESCRIPTION_INFO' => '<div><strong>Testimonial Text must be between ' . ENTRY_TESTIMONIALS_TEXT_MIN_LENGTH . ' &amp; ' . ENTRY_TESTIMONIALS_TEXT_MAX_LENGTH . ' characters!</strong></div>',
    ...
    'TEXT_CLOSED' => 'At this time, Testimonials are closed untill it\'s open',
