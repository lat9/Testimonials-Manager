...
while (!$testimonials->EOF) {
  ...
  $testimonials->MoveNext();	
    ...
    define('META_TAG_TITLE', str_replace('"','',zen_clean_html($testimonial_string_metatags) . META_TAG_TITLE_PAGE_TESTIMONIALS_MANAGER_ALL_TESTIMONIALS));
    define('META_TAG_DESCRIPTION', str_replace('"','',zen_clean_html($testimonial_string_metatags) . META_TAG_TITLE_PAGE_TESTIMONIALS_MANAGER_ALL_TESTIMONIALS));
    define('META_TAG_KEYWORDS', str_replace('"','',zen_clean_html($testimonial_string_metatags) . META_TAG_TITLE_PAGE_TESTIMONIALS_MANAGER_ALL_TESTIMONIALS));
