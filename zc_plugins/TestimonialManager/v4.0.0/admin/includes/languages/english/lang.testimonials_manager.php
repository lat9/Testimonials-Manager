 ...
 */
 $define = [
    ...
    'TEXT_TESTIMONIALS_HTML_TEXT' => 'Testimonial:<br><br>Use with HTML or plan text?<br>Creates a mess with HTML or you like it.. Just test what works with you like HTML. ONLY admin create new or edit HTML or Plan text.',
    ...
    'TEXT_IMAGES_TESTIMONIALS_DELETE' => '<strong>Use \'No Avatar\' image!</strong>',
    'TEXT_INFO_DELETE_IMAGE' => '<strong>Please Delete the Avatar image yourself!</strong>',
    'TEXT_AVATAR_IMAGE_MANUAL' => 'Switch to another select Avatar image:',
    'TEXT_AVATAR_PAGE_IMAGE' => 'Testimonial Avatar:',
    'TEXT_AVATAR_CURRENT_IMAGE' => 'Current Avatar:',
    'TEXT_AVATAR_NO_IMAGE' => 'Missing Avatar',
    ...
    'TEXT_TESTIMONIALS_IMAGE_LOCAL' => ', or enter local file below',
    'TEXT_TESTIMONIALS_IMAGE_TARGET' => 'Image Target (Save To):',
    'TEXT_TESTIMONIALS_IMAGE_TARGET_INFO' => '<strong>Suggested Target location for the image on the server:</strong> ' . DIR_FS_CATALOG_IMAGES . 'uploads/',
    'ERROR_TESTIMONIALS_IMAGE_REQUIRED' => 'Error: Testimonials image required.',
