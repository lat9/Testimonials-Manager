...
class zcObserverTestimonialManager extends base
{
    ...
    public function updateNotifyNoncaptchaObserverFieldCheck(array $current_fields, &array $updated_fields): void
    {
        $tm_fields = [
    ...
    public function updateNotifyModuleMetaTagsUnspecifiedpage(string $current_page_base): void
    {
        ...
        } elseif ($current_page === FILENAME_TESTIMONIALS_MANAGER_ALL) {
            zen_define_default('META_TAG_TITLE', META_TAG_TITLE_PAGE_TESTIMONIALS_MANAGER_ALL_TESTIMONIALS);
            return
        }
    }

    public function updateNotifyInformationSideboxAdditions(mixed $unused, &array $information): void
    {
