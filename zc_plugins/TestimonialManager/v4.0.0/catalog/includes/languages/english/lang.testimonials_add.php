...
$define = [
    ...
    'TEXT_TESTIMONIALS_DESCRIPTION_INFO' => '<div><strong>Testimonial Text must be between ' . ENTRY_TESTIMONIALS_TEXT_MIN_LENGTH . ' and ' . ENTRY_TESTIMONIALS_TEXT_MAX_LENGTH . ' characters!</strong></div>',
    ...
    'TEXT_YES' => 'yes',
    'TEXT_NO' => 'no',
    'TEXT_OPTION_1' => 'Option 1',
    'TEXT_OPTION_2' => 'Option 2',
    'TEXT_OPTION_3' => 'Option 3',
    ...
    'EXCLAMATION_TRIANGLE' => '<svg xmlns="http://www.w3.org/2000/svg" fill="rgba(7.5,81.6,11,1)" width="20px" height="auto" viewBox="0 0 576 512"><path d="M569.517 440.013C587.975 472.007 564.806 512 527.94 512H48.054c-36.937 0-59.999-40.055-41.577-71.987L246.423 23.985c18.467-32.009 64.72-31.951 83.154 0l239.94 416.028zM288 354c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"/></svg>',
    ...
    'EMAIL_SPAM_DISCLAIMER' => 'This email is sent in accordance with the US CAN-SPAM Law in effect 01/01/2004. Removal requests can be sent to this address and will be honored and respected.',
 ];
