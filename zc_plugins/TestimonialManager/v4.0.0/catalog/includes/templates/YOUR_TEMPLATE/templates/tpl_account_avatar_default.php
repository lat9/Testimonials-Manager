...
<br />
<div class="buttonRow center"><?php echo zen_image_button(BUTTON_IMAGE_DELETE, BUTTON_DELETE_ALT, ' id="file-reset" '); ?> <?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div> 
<br class="clearBoth">
<br /><br /><br />
<script>
